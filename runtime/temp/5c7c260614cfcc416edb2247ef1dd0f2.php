<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:62:"/data/wwwroot/app/application/admin/view/vedio/vedio/index.php";i:1558938203;s:61:"/data/wwwroot/app/application/admin/view/public/container.php";i:1557993192;s:62:"/data/wwwroot/app/application/admin/view/public/frame_head.php";i:1557993192;s:57:"/data/wwwroot/app/application/admin/view/public/style.php";i:1557993192;s:62:"/data/wwwroot/app/application/admin/view/public/inner_page.php";i:1557993192;s:64:"/data/wwwroot/app/application/admin/view/public/frame_footer.php";i:1557993192;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    ...
    <div class="col-sm-12">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-title">
                ...
                <a type="button" class="btn btn-w-m btn-primary" href="<?php echo url('create'); ?>">添加视频</a>
                    ...
                    <div class="m-b m-l">
                        ...
                        <form action="" class="form-inline">
                            ...
                            <div class="input-group" style="margin-top: 5px">
                                <input type="text" placeholder="请输入关键词" class="input-sm form-control" name="vedio_name" value="<?php echo $where['vedio_name']; ?>">
                    ...
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <?php echo $vo['vedio_name']; ?>

                            </td>

                            <td class="text-center">

                                <img data-image="<?php echo $vo['vedio_img']; ?>" class="vedio_img" src="<?php echo $vo['vedio_img']; ?>" alt="<?php echo $vo['vedio_img']; ?>" title="<?php echo $vo['vedio_name']; ?>" style="width: 50px;cursor: pointer">
                            ...
                            <td class="text-center">
                                ...
                                <a href="http://prhiiqxdd.bkt.clouddn.com/<?php echo $vo['vedio_url']; ?>" style="color: #666;display: block;padding: 5px 0;">查看视频</a>
                            ...
                            <td class="text-center">
                                ...
                                <a  href="<?php echo url('create',array('id'=>$vo['id'])); ?>"  class="btn btn-info btn-xs" type="button"  <i class="fa fa-paste"></i> 编辑</a>
