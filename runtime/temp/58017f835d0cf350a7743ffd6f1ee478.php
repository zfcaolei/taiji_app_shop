<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:89:"C:\phpStudy\PHPTutorial\WWW\CRMEB/application/admin\view\store\store_product\create3d.php";i:1560919717;s:77:"C:\phpStudy\PHPTutorial\WWW\CRMEB\application\admin\view\public\container.php";i:1560919708;s:78:"C:\phpStudy\PHPTutorial\WWW\CRMEB\application\admin\view\public\frame_head.php";i:1560919708;s:73:"C:\phpStudy\PHPTutorial\WWW\CRMEB\application\admin\view\public\style.php";i:1560919708;s:80:"C:\phpStudy\PHPTutorial\WWW\CRMEB\application\admin\view\public\frame_footer.php";i:1560919708;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
            ...
            <div class="tabs-container ibox-title">
                ...
                <div class="tab-content">
                    <div class="<!--ibox-content--> p-m m-t-sm">
                        <form method="post" class="form-horizontal" id="signupForm" action="<?php echo Url('mag',['id'=>$id]); ?>"  enctype="multipart/form-data" >
                                ...
                                <div class="col-sm-10">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="<?php echo $vo['type']; ?>" class="form-control" name="<?php echo $vo['menu_name']; ?>" value=""  style="width: <?php echo $vo['width']; ?>%"/>
                                            <?php
//                                            $img_image = $vo['value'];
//                                            $num_img = 0;
//                                            if(!empty($img_image)){
...
//                                            }
                                        ...
                                        <!-------**********************************------->
                                           <!-- <div style="display: inline-flex;">
                                                <input type="file" class="<?php echo $vo['menu_name']; ?>_1" name="<?php echo $vo['menu_name']; ?>" style="display: none;" data-name="<?php echo $vo['menu_name']; ?>" id="<?php echo $vo['menu_name']; ?>" data-type = "1" />
                                                    ...
                                                    <div class="<?php echo $vo['menu_name']; ?>">
                                                        <div style="position: relative;" class="file">
                                                            <div class="image open_image">
                                                                <img alt="image" class="img-responsive" data-image="http://qn.taijidjk69.com/a0019201906181751349212.png" src="http://qn.taijidjk69.com/a0019201906181751349212.png" style="width: 100%;height: 100%;cursor: pointer">
                                                            </div>
...
//                                                dump($parameter);
                                            ...
                                            <button class="btn btn-w-m btn-primary flag" type="button" data-name="<?php echo $vo['menu_name']; ?>" value=""><i class="fa fa-upload"></i><?= empty($res) ? '添加' : '修改'?>上传3d文件</button>

                                            <?php
                                            $id = request()->param('id');
                                            if (!empty($res)){
                                                ?>
                                                <div class="filetest" style="width: 250px">
                                                    <div class="file vedio_file"><span class="corner"></span>
                                                        <div class="icon">
                                                            <i class="fa fa-file"></i></div>
                                                        <div class="file-name"><?php echo $res['file_name']; ?></div>
                                                        </a><div data-name="vedio_file" data-image="" class="deleteimg" onclick="delPic(this)" title="删除">×</div><input type="hidden" name="vedio_file[]" value=""></div>
                                                </div>
                                            <?php }?>
                                            ...
                                            <div style="display: inline-flex;">
                                                <input type="file" class="<?php echo $vo['menu_name']; ?>_1" name="<?php echo $vo['menu_name']; ?>" style="display: none;" data-name="<?php echo $vo['menu_name']; ?>" id="<?php echo $vo['menu_name']; ?>" data-type = "<?php echo $vo['upload_type']; ?>" value="22222" />
                                                <?php if($num_img < 1): ?>
                                                <div class="file-box">
    ...
    function ajaxFileUpload(is) {
        ...
        $.ajaxFileUpload({
            ...
            success: function(data, status, e){
                console.log(data);
                if(data.code == 200){
                    $(".filetest").attr("style","display:none;");
