...
//                                        exit();
                             ...
                             <!--文件--><?php if($vo['upload_type'] == 3): ?>
                                            <div style="display: inline-flex;">
                                                ...
                                                <span class="flag" style="margin-top: 5px;width: 86px;height: 27px;border-radius: 6px;cursor:pointer;padding: .5rem;background-color: #18a689;color: #fff;text-align: center;" data-name="<?php echo $vo['menu_name']; ?>" >点击上传</span>
                                                    <?php if($num_img < 1): ?>
                                                     <div class="file-box">
                                                    ...
                                                    <?php else: if(is_array($vo['value']) || $vo['value'] instanceof \think\Collection || $vo['value'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['value'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$img): $mod = ($i % 2 );++$i;?>
                                                        <div class="file-box">
                                                            <div class="file <?php echo $vo['menu_name']; ?>" style="position: relative;">
                                                                ...
                                                                <div data-name="<?php echo $vo['menu_name']; ?>" style="position: absolute;right: 4%;top: 2%;cursor: pointer" onclick="delPic(this)">删除</div>
                             ...
                             <!--多图--><?php elseif($vo['upload_type'] == 2): ?>
                                            <div style="margin-top: 20px;">
                                                <input type="file" class="<?php echo $vo['menu_name']; ?>_1" name="<?php echo $vo['menu_name']; ?>" style="display: none;" data-name="<?php echo $vo['menu_name']; ?>" id="<?php echo $vo['menu_name']; ?>" data-type = "<?php echo $vo['upload_type']; ?>" />
                                                <span class="flag" style="margin-top: 5px;width: 86px;height: 27px;border-radius: 6px;cursor:pointer;padding: .5rem 1rem;background-color: #18a689;color: #fff;text-align: center;" data-name="<?php echo $vo['menu_name']; ?>" >点击上传</span>
                                                    ...
                                                    <div class="file-box">
                                                        <div class="file <?php echo $vo['menu_name']; ?>" style="position: relative;">
                                                            <a href="http://<?php echo $_SERVER['SERVER_NAME'].$img;?>" target="_blank">
                                                                <span class="corner"></span>
                                                                <div class="image">
                                                                    <img alt="image" class="img-responsive" src="<?php echo $img; ?>">
                                                                </div>
                                                                <div class="file-name">
                                                                    <?php
                                                                    //显示带有文件扩展名的文件名
                                                                ...
                                                                <div class="<?php echo $vo['menu_name']; ?>">
                                                                    <div style="position: relative;" class="file">
                                                                        <a href="http://<?php echo $_SERVER['SERVER_NAME'].$img;?>" target="_blank">
                                                                            <span class="corner"></span>
                                                                            <div class="image">
                                                                                <img alt="image" class="img-responsive" src="<?php echo $img; ?>" style="width: 100%;height: 100%">
                                                                            </div>
                                                                            <div class="file-name">
                                                                                <?php
                                                                                //显示带有文件扩展名的文件名
