<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:63:"/data/wwwroot/app/application/admin/view/vedio/vedio/create.php";i:1558938203;s:61:"/data/wwwroot/app/application/admin/view/public/container.php";i:1557993192;s:62:"/data/wwwroot/app/application/admin/view/public/frame_head.php";i:1557993192;s:57:"/data/wwwroot/app/application/admin/view/public/style.php";i:1557993192;s:64:"/data/wwwroot/app/application/admin/view/public/frame_footer.php";i:1557993192;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                                ...
                                <div class="col-sm-10">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="<?php echo $vo['type']; ?>" class="form-control" name="<?php echo $vo['menu_name']; ?>" value="<?php echo $res['vedio_name']; ?>" validate="<?php echo $vo['required']; ?>" style="width: <?php echo $vo['width']; ?>%"/>
...
//                                                dump($parameter);
                                            ...
                                            <button class="btn btn-w-m btn-primary flag" type="button" data-name="<?php echo $vo['menu_name']; ?>" value=""><i class="fa fa-upload"></i><?= empty($res) ? '添加' : '修改'?>上传视频</button>
                                            ...
                                            <div class="filetest" style="width: 250px">
                                                <div class="file vedio_file"><a href="http://www.shop.com\public/uploads\config/file\5ce5174291a72.mp4" target="_blank"><span class="corner"></span>
                                                        <div class="icon">
                                                            <i class="fa fa-file"></i></div>
                                                        <div class="file-name"><?php echo $res['vedio_url']; ?></div>
                                                    </a><div data-name="vedio_file" data-image="\public/uploads\config/file\5ce5174291a72.mp4" class="deleteimg" onclick="delPic(this)" title="删除">×</div><input type="hidden" name="vedio_file[]" value="\public/uploads\config/file\5ce5174291a72.mp4"></div>
                                            </div>
                                            <?php }?>
