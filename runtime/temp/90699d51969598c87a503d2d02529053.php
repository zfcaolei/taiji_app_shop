<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:92:"C:\phpStudy\PHPTutorial\WWW\CRMEB/application/admin\view\store\store_product\createvedio.php";i:1560919717;s:77:"C:\phpStudy\PHPTutorial\WWW\CRMEB\application\admin\view\public\container.php";i:1560919708;s:78:"C:\phpStudy\PHPTutorial\WWW\CRMEB\application\admin\view\public\frame_head.php";i:1560919708;s:73:"C:\phpStudy\PHPTutorial\WWW\CRMEB\application\admin\view\public\style.php";i:1560919708;s:80:"C:\phpStudy\PHPTutorial\WWW\CRMEB\application\admin\view\public\frame_footer.php";i:1560919708;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
            ...
            <div class="tabs-container ibox-title">
                ...
                <div class="tab-content">
                    <div class="<!--ibox-content--> p-m m-t-sm">
                        <form method="post" class="form-horizontal" id="signupForm" action="<?php echo Url('magvedio',['id'=>$id]); ?>"  enctype="multipart/form-data" >
...
//                                                dump($parameter);
                                            ...
                                            <button class="btn btn-w-m btn-primary flag" type="button" data-name="<?php echo $vo['menu_name']; ?>" value=""><i class="fa fa-upload"></i>上传视频</button>
                                            ...
                                            <div class="filetest" style="width: 250px">
                                                <div class="file vedio_file"><a href="<?php echo $res['vedio_url']; ?>" target="_blank"><span class="corner"></span>
                                                        <div class="icon">
