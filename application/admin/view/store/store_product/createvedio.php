            ...
            <div class="tabs-container ibox-title">
                ...
                <div class="tab-content">
                    <div class="<!--ibox-content--> p-m m-t-sm">
                        <form method="post" class="form-horizontal" id="signupForm" action="{:Url('magvedio',['id'=>$id])}"  enctype="multipart/form-data" >
...
//                                                dump($parameter);
                                            ...
                                            <button class="btn btn-w-m btn-primary flag" type="button" data-name="{$vo.menu_name}" value=""><i class="fa fa-upload"></i>上传视频</button>
                                            ...
                                            <div class="filetest" style="width: 250px">
                                                <div class="file vedio_file"><a href="{$res['vedio_url']}" target="_blank"><span class="corner"></span>
                                                        <div class="icon">
