            ...
            <div class="tabs-container ibox-title">
                ...
                <div class="tab-content">
                    <div class="<!--ibox-content--> p-m m-t-sm">
                        <form method="post" class="form-horizontal" id="signupForm" action="{:Url('mag',['id'=>$id])}"  enctype="multipart/form-data" >
                                ...
                                <div class="col-sm-10">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="{$vo.type}" class="form-control" name="{$vo.menu_name}" value=""  style="width: {$vo.width}%"/>
                                            <?php
//                                            $img_image = $vo['value'];
//                                            $num_img = 0;
//                                            if(!empty($img_image)){
...
//                                            }
                                        ...
                                        <!-------**********************************------->
                                           <!-- <div style="display: inline-flex;">
                                                <input type="file" class="{$vo.menu_name}_1" name="{$vo.menu_name}" style="display: none;" data-name="{$vo.menu_name}" id="{$vo.menu_name}" data-type = "1" />
...
//                                                dump($parameter);
                                            ...
                                            <button class="btn btn-w-m btn-primary flag" type="button" data-name="{$vo.menu_name}" value=""><i class="fa fa-upload"></i><?= empty($res) ? '添加' : '修改'?>上传3d文件</button>
                                            ...
                                            if (!empty($res)){
                                                ...
                                                <div class="filetest" style="width: 250px">
                                                    <div class="file vedio_file"><span class="corner"></span>
                                                        ...
                                                        <div class="file-name">{$res['file_name']}</div>
                                            ...
                                            <div style="display: inline-flex;">
                                                <input type="file" class="{$vo.menu_name}_1" name="{$vo.menu_name}" style="display: none;" data-name="{$vo.menu_name}" id="{$vo.menu_name}" data-type = "{$vo.upload_type}" value="22222" />
                                                {if condition="$num_img LT 1"}
                                                <div class="file-box">
