            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="act">
                        ...
                        <a type="button" class="layui-btn layui-btn-xs layui-btn-normal" href="{:Url('create3d')}?id={{d.id}}">
                            3d
                        </a>
                        <a type="button" class="layui-btn layui-btn-xs layui-btn-normal" href="{:Url('createvedio')}?id={{d.id}}">
                            视频
                        </a>
