    ...
    <div class="col-sm-12">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-title">
                ...
                <a type="button" class="btn btn-w-m btn-primary" href="{:url('index')}">添加图片</a>
                    ...
                    <div class="m-b m-l">
                        ...
                        <form action="" class="form-inline">
                            ...
                            <div class="input-group" style="margin-top: 5px">
                                <input type="text" placeholder="请输入关键词" class="input-sm form-control" name="pic_name" value="{$where.pic_name}">
                    ...
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <img data-image="{$vo.pic_url}" class="pic_url" src="{$vo.pic_url}" alt="{$vo.pic_url}" title="{$vo.pic_name}" style="width: 50px;cursor: pointer">
                            ...
                            <td class="text-center">
                                ...
                                <a href="http://prhiiqxdd.bkt.clouddn.com/{$vo['pic_qn_url']}" style="color: #666;display: block;padding: 5px 0;">查看图片</a>
                            ...
                            <td class="text-center">
                                ...
                                <a  href="{:url('index',array('id'=>$vo['id']))}"  class="btn btn-info btn-xs" type="button"  <i class="fa fa-paste"></i> 编辑</a>
