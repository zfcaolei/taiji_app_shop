            ...
            <div class="tabs-container ibox-title">
                ...
                <div class="tab-content">
                    <div class="<!--ibox-content--> p-m m-t-sm">
                        <form method="post" class="form-horizontal" id="signupForm" action="{:Url('save_basics',['id'=>$id])}" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-10">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="{$vo.type}" class="form-control" name="{$vo.menu_name}" value="<?=empty($res['pic_name']) ?  '' : $res['pic_name']?>" validate="{$vo['required']}" style="width: {$vo.width}%"/>
                                            {/case}
                                                ...
                                                <div class="file-box">
                                                    <div class="{$vo.menu_name}">
                                                        <div style="position: relative;" class="file">
                                                            <div class="image open_image">
                                                                <img alt="image" class="img-responsive" data-image="{$img}" src="<?=empty($res['pic_url']) ?  '' : $res['pic_url']?>" style="width: 100%;height: 100%;cursor: pointer">
                                                            </div>
                                                            <div data-name="{$vo.menu_name}" data-image="{$img}" class="deleteimg" onclick="delPic(this)" title="删除">×</div>
                                                            <input type="hidden" name="{$vo.menu_name}[]" value="{$img}">
                                                        </div>
