                                ...
                                <div class="col-sm-10">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="{$vo.type}" class="form-control" name="{$vo.menu_name}" value="{$res.vedio_name}" validate="{$vo['required']}" style="width: {$vo.width}%"/>
                                            {/case}
...
//                                                dump($parameter);
                                            ...
                                            <button class="btn btn-w-m btn-primary flag" type="button" data-name="{$vo.menu_name}" value=""><i class="fa fa-upload"></i><?= empty($res) ? '添加' : '修改'?>上传视频</button>
                                            ...
                                            <div class="filetest" style="width: 250px">
                                                <div class="file vedio_file"><a href="http://www.shop.com\public/uploads\config/file\5ce5174291a72.mp4" target="_blank"><span class="corner"></span>
                                                        ...
                                                        <div class="file-name">{$res['vedio_url']}</div>
